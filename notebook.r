...
ggplot(difficulty, aes(level, p_win)) + geom_line() + scale_x_continuous(breaks = 1:15) + scale_y_continuous(label=scales::percent)
...
ggplot(difficulty, aes(level, p_win)) + geom_line() + scale_x_continuous(breaks = 1:15) + scale_y_continuous(label=scales::percent) + 
geom_point() + geom_hline(yintercept=0.1, linetype='dashed')
...
ggplot(difficulty, aes(level, p_win)) + geom_line() + scale_x_continuous(breaks = 1:15) + scale_y_continuous(label=scales::percent) + 
geom_point() + geom_hline(yintercept=0.1, linetype='dashed') +
geom_errorbar(aes(ymin = p_win - error, ymax = p_win + error), width = 0.2)
